...
class CustomDataset(Dataset):
    def __init__(self, dataset_path, dataset_name, is_train=False) -> None:
        super().__init__()
        # assert dataset_name in ["humaneval", "codet_humaneval", "mbpp", "mbpp_sanitized", "nl2bash", "mbpp_validation"]
        self.dataset = []
        if dataset_name.startswith("humaneval"):
        ...
        elif dataset_name == "codet_humaneval":
            with open(dataset_path, "r") as f:
                for line in f:
                    json_obj = json.loads(line)
                    data = {
            ...
            with open(dataset_path, "r") as f:
                for line in f:
                    ...
                    self.dataset.append(data)
        elif dataset_name == "mbpp_validation":
            with open(dataset_path, "r") as f:
                for line in f:
                    json_obj = json.loads(line)
                    data = {
